...
map.getView().fit([-799028.019453, 1010236.595044, 670338.519811, 1744431.004072], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DISTRIBUTION SPATIALE DE LA POPULATION DU  BURKINA FASO PAR PROVINCE</h2>';
        return titleElement;
    })(),
